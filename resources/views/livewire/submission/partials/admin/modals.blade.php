    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
                <div class="w-10 h-10 bg-gradient-to-br from-{{ $actionType === 'approve' ? 'emerald' : 'red' }}-100 to-{{ $actionType === 'approve' ? 'teal' : 'pink' }}-100 rounded-lg flex items-center justify-center mr-3">
                    <i class="fas {{ $actionType === 'approve' ? 'fa-circle-check' : 'fa-times' }} text-{{ $actionType === 'approve' ? 'emerald' : 'red' }}-600"></i>
                </div>
        ...
        <form wire:submit="processSubmission">
            <div class="mb-6">
