<div>
    ...
    <div class="mb-6 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 text-emerald-800 px-5 py-4 rounded-xl flex items-center shadow-sm">
    ...
    <div class="mb-6 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 text-red-800 px-5 py-4 rounded-xl flex items-center shadow-sm">
    ...
    @auth
    @if(Auth::user()->hasRole('mahasiswa'))
    @include('livewire.submission.partials.mahasiswa.modals')
    @elseif(Auth::user()->hasRole('admin'))
    @include('livewire.submission.partials.admin.modals')
    @elseif(Auth::user()->hasRole('pimpinan'))
    @include('livewire.submission.partials.pimpinan.modals')
    @endif
    @endauth
</div>